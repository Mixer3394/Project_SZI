...
// klasyfikacja elementu/ atrybutów
...
class newElement {
	...
	public newElement(String color, String weight, String kindOfMaterial, String stateOfAgregation) {

		attDataMap.put("Color", color);
		attDataMap.put("Weight", weight);
		attDataMap.put("KindOfMaterial", kindOfMaterial);
		attDataMap.put("StateOfAgregation", stateOfAgregation);
